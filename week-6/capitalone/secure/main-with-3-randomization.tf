...
resource "aws_s3_bucket" "secure_bucket" {
  bucket        = "seas8405-week6-lab1-secure-s3-${random_id.bucket_suffix.hex}"
  force_destroy = true
  tags = {
    Name = "secure-s3-bucket-${random_id.bucket_suffix.hex}"
  }
}
...
resource "aws_s3_bucket" "trail_bucket" {
  bucket        = "seas8405-week6-lab1-secure-trail-s3-${random_id.bucket_suffix.hex}"
  force_destroy = true
  tags = {
    Name = "secure-trail-s3-${random_id.bucket_suffix.hex}"
  }
}
